package net.keegers02.tutorialmod.item;
...
public class ModItems {
    ...
    // This one is different to pick up the full set benefit. Only one needs to be changed to this.
    ...
    public static final Item INTER_REALMS_SMITHING_TEMPLATE = registerItem("inter_realms_smithing_template",
            SmithingTemplateItem.of(Identifier.of(TutorialMod.MOD_ID, "inter_realms"), FeatureFlags.VANILLA));
