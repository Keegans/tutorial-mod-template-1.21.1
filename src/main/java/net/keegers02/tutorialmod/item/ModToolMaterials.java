...
import net.keegers02.tutorialmod.util.ModTags;
...
//    NETHERITE(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 2031, 9.0F, 4.0F, 15, () -> Ingredient.ofItems(Items.NETHERITE_INGOT));
    PINK_GARNET(ModTags.Blocks.INCORRECT_FOR_PINK_GARNET_TOOL, 1200,
        5.0F, 4.0F, 22, () -> Ingredient.ofItems(ModItems.PINK_GARNET));
